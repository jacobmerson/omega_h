...
void push_tags(Mesh *old_mesh, Mesh* new_mesh, Int ent_dim,
  ...
  for (Int i = 0; i < old_mesh->ntags(ent_dim); ++i) {
    ...
    if (is<I8>(tag)) {
      ...
      auto array = old_mesh->get_array<I8>(ent_dim,name);
      array = old_owners2new_ents.exch(array, ncomps);
      new_mesh->add_tag<I8>(ent_dim, name, ncomps, array, true);
      ...
      auto array = old_mesh->get_array<I32>(ent_dim,name);
      array = old_owners2new_ents.exch(array, ncomps);
      new_mesh->add_tag<I32>(ent_dim, name, ncomps, array, true);
      ...
      auto array = old_mesh->get_array<I64>(ent_dim,name);
      array = old_owners2new_ents.exch(array, ncomps);
      new_mesh->add_tag<I64>(ent_dim, name, ncomps, array, true);
      ...
      auto array = old_mesh->get_array<Real>(ent_dim,name);
      array = old_owners2new_ents.exch(array, ncomps);
      new_mesh->add_tag<Real>(ent_dim, name, ncomps, array, true);
